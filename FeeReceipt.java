...
class FeeReceipt {
    ...
    public static void main(String[] args) {
        ...
        JLabel headerlabel = new JLabel("         FEE RECEIPT");
        JPanel sname = new JPanel();
        JLabel snamelabel = new JLabel("STUDENT NAME : ");
        JPanel sclass = new JPanel();
        JLabel sclasslabel = new JLabel("CLASS : ");
        JPanel fname = new JPanel();
        JLabel fnamelabel = new JLabel("FATHER'S NAME:");
        JPanel fmobile = new JPanel();
        JLabel fmobilelabel = new JLabel("FATHER'S PH:");
        JPanel mname = new JPanel();
        JLabel mnamelabel = new JLabel("MOTHER'S NAME:");
        JPanel mmobile = new JPanel();
        JLabel mmobilelabel = new JLabel("MOTHER'S PH:");
        JPanel saddress = new JPanel();
        JLabel saddresslabel = new JLabel("ADDRESS : ");
        JPanel smobile = new JPanel();
        JLabel smobilelabel = new JLabel("STUDENT'S PH:");
        ...
        cntr.setLayout(null);
        cntr.setBackground(Color.DARK_GRAY);
        cntr.add(header);
